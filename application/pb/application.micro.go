...
type ApplicationService interface {
	Create(ctx context.Context, in *CreateRequest, opts ...client.CallOption) (*xbasis_commons_dto.Status, error)
	Remove(ctx context.Context, in *RemoveRequest, opts ...client.CallOption) (*xbasis_commons_dto.Status, error)
	ChangeName(ctx context.Context, in *ChangeNameRequest, opts ...client.CallOption) (*xbasis_commons_dto.Status, error)
	...
	Switch(ctx context.Context, in *SwitchRequest, opts ...client.CallOption) (*xbasis_commons_dto.Status, error)
}
...
func (c *applicationService) Create(ctx context.Context, in *CreateRequest, opts ...client.CallOption) (*xbasis_commons_dto.Status, error) {
...
func (c *applicationService) Remove(ctx context.Context, in *RemoveRequest, opts ...client.CallOption) (*xbasis_commons_dto.Status, error) {
...
func (c *applicationService) ChangeName(ctx context.Context, in *ChangeNameRequest, opts ...client.CallOption) (*xbasis_commons_dto.Status, error) {
...
func (c *applicationService) Switch(ctx context.Context, in *SwitchRequest, opts ...client.CallOption) (*xbasis_commons_dto.Status, error) {
...
type ApplicationHandler interface {
	Create(context.Context, *CreateRequest, *xbasis_commons_dto.Status) error
	Remove(context.Context, *RemoveRequest, *xbasis_commons_dto.Status) error
	ChangeName(context.Context, *ChangeNameRequest, *xbasis_commons_dto.Status) error
	...
	Switch(context.Context, *SwitchRequest, *xbasis_commons_dto.Status) error
}

func RegisterApplicationHandler(s server.Server, hdlr ApplicationHandler, opts ...server.HandlerOption) error {
	type application interface {
		Create(ctx context.Context, in *CreateRequest, out *xbasis_commons_dto.Status) error
		Remove(ctx context.Context, in *RemoveRequest, out *xbasis_commons_dto.Status) error
		ChangeName(ctx context.Context, in *ChangeNameRequest, out *xbasis_commons_dto.Status) error
		...
		Switch(ctx context.Context, in *SwitchRequest, out *xbasis_commons_dto.Status) error
	}
...
func (h *applicationHandler) Create(ctx context.Context, in *CreateRequest, out *xbasis_commons_dto.Status) error {
	return h.ApplicationHandler.Create(ctx, in, out)
}

func (h *applicationHandler) Remove(ctx context.Context, in *RemoveRequest, out *xbasis_commons_dto.Status) error {
	return h.ApplicationHandler.Remove(ctx, in, out)
}

func (h *applicationHandler) ChangeName(ctx context.Context, in *ChangeNameRequest, out *xbasis_commons_dto.Status) error {
...
func (h *applicationHandler) Switch(ctx context.Context, in *SwitchRequest, out *xbasis_commons_dto.Status) error {
