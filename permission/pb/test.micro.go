...
func (c *hiService) SayHello(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
...
func (h *hiHandler) SayHello(ctx context.Context, in *Request, out *Response) error {
