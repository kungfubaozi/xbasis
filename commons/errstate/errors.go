...
var (
	...
	FinishedInvited                = &gs_commons_dto.State{Ok: true, Code: 1002, Message: "success"}
	...
	ErrUserNeedSetUsername         = &gs_commons_dto.State{Ok: false, Code: 20057, Message: "err need username"}
)
